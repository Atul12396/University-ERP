...
SECRET_KEY = 'django-insecure-+0dr_mh&r(fmbnwn)a^%knh06o!ohoa2p*x)pxsz#=qj2b1_)6'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'templates'),  # Assuming 'templates' is the name of your templates directory
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Final ERP/Final ERP/ERP/settings.py
